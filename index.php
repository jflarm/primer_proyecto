...
<body>
    ...
    <header class="header text-center">	    
	    <h1 class="blog-name pt-lg-4 mb-0"><a href="index.html">Aventuras de BetaFrank
    ...
    <div class="main-wrapper">
	    <section class="cta-section theme-bg-light py-5">
		    <div class="container text-center">
				...
				?>
				<form action="login.php" class="signup-form form-inline justify-content-center pt-3">
				...
				?>
					...
					<form action="logout.php" class="signup-form form-inline justify-content-center pt-3">
					...
					<div class="item mb-5">
						<div class="media">
							...
							<div class="media-body">
								<h3 class="title mb-1"><a href="blog-post.html"><?php echo $title; ?></a></h3>
								<div class="meta mb-1"><span class="date"><?php echo $published_day; ?></span><span class="time"></span><span class="comment"><a href="#"><?php echo $comments; ?></a></span></div>
								<div class="intro"><?php echo $text; ?></div>
								<a class="more-link" href="blog-post.php?post=<?php echo $id_post; ?>">Read more &rarr;</a>
							</div><!--//media-body-->
						</div><!--//media-->
					</div><!--//item-->
