<?php 
	...
	$data_post = mysqli_fetch_array($result);
...
<body>
	<?php 
		echo '<span>Este es un texto de prueba.</span>';
	?>
	    ...
	    <article class="blog-post px-3 py-5 p-md-5">
		    <div class="container">
			    <header class="blog-post-header">
				    <h2 class="title mb-2"><?php echo $data_post['titulo'];  ?></h2>
				    <div class="meta mb-3"><span class="date"><?php echo $data_post['fecha']; ?></span><span class="time">5 min read</span><span class="comment"><a href="#">4 comments</a></span></div>
			    </header>
